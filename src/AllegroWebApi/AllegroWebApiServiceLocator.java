...
public class AllegroWebApiServiceLocator extends org.apache.axis.client.Service implements AllegroWebApi.AllegroWebApiService {
    ...
    public AllegroWebApi.AllegroWebApiPortType getAllegroWebApiPort() throws javax.xml.rpc.ServiceException {
    ...
    public AllegroWebApi.AllegroWebApiPortType getAllegroWebApiPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            AllegroWebApi.AllegroWebApiBindingStub _stub = new AllegroWebApi.AllegroWebApiBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (AllegroWebApi.AllegroWebApiPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                AllegroWebApi.AllegroWebApiBindingStub _stub = new AllegroWebApi.AllegroWebApiBindingStub(new java.net.URL(AllegroWebApiPort_address), this);
                _stub.setPortName(getAllegroWebApiPortWSDDServiceName());
                return _stub;
            }
        }
