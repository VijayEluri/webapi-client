...
public class UserPaymentStruct  implements java.io.Serializable {
    ...
    private AllegroWebApi.PaymentDetailsStruct[] payTransDetails;
    ...
    public UserPaymentStruct(
           ...
           AllegroWebApi.PaymentDetailsStruct[] payTransDetails) {
     ...
     */
    public AllegroWebApi.PaymentDetailsStruct[] getPayTransDetails() {
        return payTransDetails;
    }
     ...
     */
    public void setPayTransDetails(AllegroWebApi.PaymentDetailsStruct[] payTransDetails) {
        this.payTransDetails = payTransDetails;
    }
