...
public class ItemInfoStruct  implements java.io.Serializable {
    private AllegroWebApi.ItemInfo itemInfo;

    private AllegroWebApi.ItemCatList[] itemCats;

    private AllegroWebApi.ItemImageList[] itemImages;

    private AllegroWebApi.AttribStruct[] itemAttribs;
    ...
    public ItemInfoStruct(
           AllegroWebApi.ItemInfo itemInfo,
           AllegroWebApi.ItemCatList[] itemCats,
           AllegroWebApi.ItemImageList[] itemImages,
           AllegroWebApi.AttribStruct[] itemAttribs,
           AllegroWebApi.PostageStruct[] itemPostageOptions,
           AllegroWebApi.ItemPaymentOptions itemPaymentOptions,
           AllegroWebApi.CompanyInfoStruct itemCompanyInfo) {
     ...
     * @return itemInfo
     */
    public AllegroWebApi.ItemInfo getItemInfo() {
        return itemInfo;
    }
     ...
     * @param itemInfo
     */
    public void setItemInfo(AllegroWebApi.ItemInfo itemInfo) {
        this.itemInfo = itemInfo;
    }
     ...
     * @return itemCats
     */
    public AllegroWebApi.ItemCatList[] getItemCats() {
        return itemCats;
    }
     ...
     * @param itemCats
     */
    public void setItemCats(AllegroWebApi.ItemCatList[] itemCats) {
        this.itemCats = itemCats;
    }
     ...
     * @return itemImages
     */
    public AllegroWebApi.ItemImageList[] getItemImages() {
        return itemImages;
    }
     ...
     * @param itemImages
     */
    public void setItemImages(AllegroWebApi.ItemImageList[] itemImages) {
        this.itemImages = itemImages;
    }
     ...
     * @return itemAttribs
     */
    public AllegroWebApi.AttribStruct[] getItemAttribs() {
        return itemAttribs;
    }
     ...
     * @param itemAttribs
     */
    public void setItemAttribs(AllegroWebApi.AttribStruct[] itemAttribs) {
        this.itemAttribs = itemAttribs;
    }
     ...
     */
    public AllegroWebApi.PostageStruct[] getItemPostageOptions() {
        return itemPostageOptions;
    }
     ...
     */
    public AllegroWebApi.ItemPaymentOptions getItemPaymentOptions() {
        return itemPaymentOptions;
    }
     ...
     */
    public AllegroWebApi.CompanyInfoStruct getItemCompanyInfo() {
        return itemCompanyInfo;
    }
